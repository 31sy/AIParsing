...
class convx_head(nn.Module):
    ...
    def __init__(self, dim_in):
        ...
        self.dim_in = dim_in + cfg.AIParsing.NUM_PARSING
        num_stacked_convs = cfg.AIParsing.PARSINGIOU.NUM_STACKED_CONVS  # default = 2
        conv_dim = cfg.AIParsing.PARSINGIOU.CONV_DIM
        mlp_dim = cfg.AIParsing.PARSINGIOU.MLP_DIM
        use_bn = cfg.AIParsing.PARSINGIOU.USE_BN
        use_gn = cfg.AIParsing.PARSINGIOU.USE_GN
    ...
    def forward(self, x, parsing_logits):
        parsing_pool = F.max_pool2d(parsing_logits, kernel_size=8, stride=8)
