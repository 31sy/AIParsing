...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "CIHP_train": {  # new addition by zsy
            "img_dir":  "CIHP/train_img",
            "ann_file": "CIHP/annotations/CIHP_train.json",
        },
        "CIHP_val": {  # new addition by zsy
            "img_dir": "CIHP/val_img",
            "ann_file": "CIHP/annotations/CIHP_val.json",
        },
        "CIHP_test": {  # new addition by zsy
    ...
    def get(name):
        ...
        if "CIHP" in name or "coco" in name or "LV-MHP" in name :
